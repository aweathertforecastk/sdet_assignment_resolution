Feature: Cleaning service validation
  ...
  Examples: Negative tests
    | test_name                                                    | roomSize    | coords    | patches                                                 | instructions                       | expected_status | expected_coords | expected_patches |
    | Verify hoover cannot start with X-coordinate out of bounds   | [5, 6]      | [6, 3]    | [[1, 2], [3, 3]]                                        | WWW                                | 400             | []              | 0                |
    ...
    | Verify hoover cannot operate if empty room size              | []          | [5, 6]    | [[1, 1], [3, 1]]                                        | SW                                 | 500             | []              | 0                |
    ...
    | Verify service rejects negative integer in room_size X       | [5, -5]     | [7, 11]   | [[5, 7]]                                                | WSSESW                             | 400             | []              | 0                |
    | Verify service rejects negative integer in room_size Y       | [14, -3]    | [7, 1]    | [[4, 7]]                                                | NWEEWEWE                           | 400             | []              | 0                |
    | Verify service rejects negative integer in coords X          | [10, 13]    | [-7, 0]   | [[4, 5]]                                                | NNEEES                             | 400             | []              | 0                |
    | Verify service rejects negative integer in coords Y          | [10, 17]    | [0, -3]   | [[4, 5]]                                                | NNEW                               | 400             | []              | 0                |
    | Verify service rejects negative integer in patches X         | [12, 15]    | [0, 0]    | [[-4, 5]]                                               | EEEEEWWWW                          | 400             | []              | 0                |
    | Verify service rejects negative integer in patches Y         | [10, 13]    | [0, 0]    | [[4, -5]]                                               | SWE                                | 400             | []              | 0                |
    | Verify service rejects float integer in room_size X          | [1.0, 13]   | [0, 0]    | [[9, 5]]                                                | SS                                 | 400             | []              | 0                |
    | Verify service rejects float integer in room_size Y          | [3, 5.3]    | [0, 0]    | [[4, 2]]                                                | NWEES                              | 400             | []              | 0                |
    | Verify service rejects float integer in coords X             | [10, 13]    | [7.8, 10] | [[4, 10]]                                               | NNEE                               | 400             | []              | 0                |
    | Verify service rejects float integer in coords Y             | [10, 13]    | [7, 3.2]  | [[8, 5]]                                                | NNES                               | 400             | []              | 0                |
    | Verify service rejects float integer in patches X            | [8, 15]     | [0, 0]    | [[4.7, 5]]                                              | NEEES                              | 400             | []              | 0                |
    | Verify service rejects float integer in patches Y            | [7, 14]     | [0, 0]    | [[4, 5.3]]                                              | NNEE                               | 400             | []              | 0                |
